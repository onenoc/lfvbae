...
if __name__=='__main__':
    #true posterior
    muTrue = (sigmaPrior**2)*Sy/(sigmaData**2/M+sigmaPrior**2)+(sigmaData**2)*muPrior/(sigmaData**2/M+sigmaPrior**2)
    sigmaTrue = 1./(1/(sigmaPrior**2)+M/(sigmaData**2))
